...
import { checkPaymentStatus, createConnectCheckoutSession } from '@/lib/checkout';
import { Button } from '@/components/ui/button';
import { toast } from '@/components/ui/use-toast';
import { Card, CardContent, CardFooter, CardHeader, CardTitle, CardDescription } from '@/components/ui/card';
import { Spinner } from '@/components/ui/spinner';

const PaymentConnectHandler = () => {
	...
	useEffect(() => {
		...
		const handlePaymentStatus = async () => {
			...
			try {
				...
				console.log("success:", success, "canceled:", canceled, "checkoutSessionId:", checkoutSessionId, "offerId:", offerId);
				if (success && checkoutSessionId && offerId) {
	...
	const handleRetry = async () => {
		...
		const isConnectPayment = localStorage.getItem("isConnectPayment");
		...
		try {
			...
			if (isConnectPayment === "true") {
				const { url } = await createConnectCheckoutSession({
					amount: Number(localStorage.getItem("amount")),
					currency: localStorage.getItem("currency") || 'usd',
					vendorStripeAccountId: localStorage.getItem("vendorStripeAccountId") || '',
...
export default PaymentConnectHandler;
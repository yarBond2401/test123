    ...
    <div className="flex flex-col justify-start gap-2">
      {!isSender && (
        <div className="flex flex-col">
          <p className="text-sm leading-5 text-[#637381] self-start">{chatDetails.userDetails.name}</p>
        </div>
      )}
      <div className={cn(
    ...
    >
      <div className="flex justify-between p-6 pt-5 items-center">
        ...
        <div className="relative 2xl:h-11 2xl:w-11 md:h-8 md:w-8 h-11 w-11 shrink-0">
          {chatDetails.userDetails.photo ? (
            <Image src={chatDetails.userDetails.photo} alt={chatDetails.userDetails.name} className="w-full h-auto rounded-full" />
          ) : (
          ...
          <div className="flex flex-col ml-4">
            {chatDetails?.userDetails ? (
              <p className="font-medium text-lg leading-6 text-dashboard-main">{chatDetails.userDetails.name}</p>
            ) : (
